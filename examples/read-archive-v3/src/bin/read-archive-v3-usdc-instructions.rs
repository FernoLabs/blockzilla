...
const USAGE: &str = "usage:\n  read-archive-v3-usdc-instructions local-split <absolute-v3-ledger-root> <absolute-retained-root> <epoch> <candidate-id> <absolute-output.sqlite> <max-blocks> --threads <1..=64>";
