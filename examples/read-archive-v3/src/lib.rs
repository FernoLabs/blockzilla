...
) -> blockzilla_archive_v3_reader::Result<ScanRequest> {
...
pub fn finish_archive(
    archive: IndexerV3Archive,
) -> blockzilla_archive_v3_reader::Result<IndexerV3TransportReceipt> {
...
mod tests {
    ...
    fn slot_hour_reader_has_no_output_or_block_option() {
        ...
        let help = count_arguments_from("read-archive-v3-slot-hours", [OsString::from("--help")])
            .unwrap_err()
            .to_string();
