...
mod tests {
    ...
    fn signed_test_code_shred(
        ...
        // A 32-data + 32-code batch has 64 Merkle leaves and therefore needs six proof entries.
        // Proof size zero is valid only for leaf index zero; coding leaves start at index 32.
