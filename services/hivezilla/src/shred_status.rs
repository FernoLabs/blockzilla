...
mod tests {
    ...
    #[test]
    fn canonical_bytes_match_the_python_migration_oracle() {
        let root = TempDir::new().unwrap();
        let status = build_status_from_values(
            &config(root.path()),
            2_000,
