...
use blockzilla_archive_v2::{
    ...
    ArchiveV2WireRewriteErrorKind, ArchiveV2WireRewriteLimits, BLOCK_TIME_GAP_FILE,
    ...
    WINCODE_ARCHIVE_V2_HOT_BLOCK_VERSION, WincodeArchiveV2Footer,
...
mod tests {
    ...
    use blockzilla_archive_v2::{
        ...
        WINCODE_ARCHIVE_V2_FLAG_LEB128, WincodeArchiveV2Footer, WincodeArchiveV2Header,
        read_archive_v2_hot_block_index, write_archive_v2_block_access_index,
    };
    use blockzilla_compact::{
        CompactInstructionError, CompactMessageHeader, CompactTransactionError,
