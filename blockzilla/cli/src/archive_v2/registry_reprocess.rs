...
use blockzilla_archive_v2::{
    ...
    read_archive_v2_hot_block_index, rewrite_archive_v2_metadata_wire,
...
mod tests {
    ...
    use blockzilla_compact::{
        CompactInnerInstruction, CompactInstructionError, DataArray, DataTable,
