...
use blockzilla_archive_v2::{
    ...
    WINCODE_ARCHIVE_V2_BLOCK_ACCESS_VERSION, WincodeArchiveV2NoRegistryBlock,
    WincodeArchiveV2NoRegistryBlockHeader, WincodeArchiveV2NoRegistryLogs,
    ...
    WincodeArchiveV2Payload, read_archive_v2_block_access_index, read_archive_v2_get_block_index,
...
use blockzilla_primitives::{
    ...
    framed::write_u32_varint, wincode_leb128_config,
};
...
mod tests {
    ...
    fn materializes_and_resumes_without_canonical_sidecars() {
        ...
        let hot_block =
            blockzilla_archive_v2::deserialize_archive_v2_hot_block_blob(&decoded).unwrap();
