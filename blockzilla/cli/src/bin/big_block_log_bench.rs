...
use blockzilla_archive_v2::{
    ...
    WincodeLogArchiveHeaderV2, WincodeLogArchiveV2, WincodeTxLogRange,
};
...
use blockzilla_program_logs::{
    program_logs::ProgramLog, program_logs::account_compression,
    program_logs::address_lookup_table, program_logs::associated_token_account,
    program_logs::loader_v3, program_logs::loader_v4, program_logs::memo, program_logs::record,
    program_logs::stake, program_logs::system_program, program_logs::token,
    program_logs::token_2022, program_logs::transfer_hook, program_logs::zk_elgamal_proof,
};
...
fn render_markdown(report: &Report) -> String {
    ...
    out.push_str(
        "Fixture: `crates/old-faithful/of-car-reader/benches/fixtures/epoch-822-biggest.car`.\n\n",
    );
