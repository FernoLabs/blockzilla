...
mod tests {
    ...
    fn epoch_998_block_104794_fixture(
        ...
        use blockzilla_archive_v2::{
            ...
            ArchiveV2HotTxRow, WincodeArchiveV2PohRecord, write_archive_v2_hot_block_index,
        };
    ...
    fn poh_orphan_repair_fixture(label: &str) -> PohOrphanRepairFixture {
        use blockzilla_archive_v2::{
            ...
            BlockTimeGapSidecar, BlockTimeGapSourceKind, WINCODE_ARCHIVE_V2_FLAG_LEB128,
            WINCODE_ARCHIVE_V2_HOT_BLOCK_VERSION, WincodeArchiveV2Footer, WincodeArchiveV2Header,
            WincodeArchiveV2ShreddingRecord, write_archive_v2_hot_block_index,
            write_block_time_gap_sidecar,
        };
        use blockzilla_compact::CompactPohEntry;
        ...
        for (block_id, slot) in [(0, first_slot), (1, last_slot)] {
            ...
            let uncompressed = wincode::config::serialize(
                &hot_block,
                blockzilla_primitives::wincode_leb128_config(),
            )
            .unwrap();
    ...
    fn migrate_poh_signature_counts_patches_batched_blocks_across_worker_threads() {
        use blockzilla_archive_v2::{
            ArchiveV2HotBlockBlob, ArchiveV2HotBlockHeader, ArchiveV2HotBlockIndexRow,
            ArchiveV2HotTxRow, write_archive_v2_hot_block_index,
        };
        use blockzilla_compact::CompactPohEntry;
