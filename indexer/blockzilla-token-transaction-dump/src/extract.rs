...
use blockzilla_primitives::{
    CompactPubkey, WincodeLeb128FramedWriter, bounded_wincode_leb128_config, encode_with_scratch,
};
...
mod tests {
    use blockzilla_archive_v2::{
        ...
        ArchiveV2HotTxRow, ArchiveV2HotV0Message, WINCODE_ARCHIVE_V2_FLAG_LEB128,
