...
/// publisher can add or replace a generation object and no User-program index
...
///
/// Acquisition fails while the User-program index controller is running. This is
...
impl MarkerTransitionLocks {
    pub fn acquire(archive: &Path, controller_state_root: &Path) -> Result<Self> {
        ...
        let result =
            ...
            result == 0,
            "the User-program index controller is running; stop it before a marker transition"
        );
...
fn audit_matches_evidence(
    ...
    use crate::user_program_index_wire_profile_attestation::FullGenerationAuditDecisionV3;
...
mod tests {
    use super::*;
    use crate::user_program_index_wire_profile_attestation::{
