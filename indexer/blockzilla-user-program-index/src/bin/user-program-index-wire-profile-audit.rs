...
#[cfg(test)]
use blockzilla_user_program_index::user_program_index_wire_profile_attestation::validate_receipt_source_recovery_evidence;
...
#[derive(Debug, Parser)]
#[command(
    name = "user-program-index-wire-profile-audit",
...
struct Args {
    ...
    /// Exact content identity calculated by the User-program index controller.
    #[arg(long)]
