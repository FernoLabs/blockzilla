...
use anyhow::Result;
use blockzilla_user_program_index::user_program_index_wire_profile_transition::{
...
#[derive(Debug, Parser)]
#[command(
    name = "user-program-index-wire-profile-marker-transition",
...
struct Args {
    ...
    #[arg(long)]
    archive: PathBuf,
    /// Existing canonical User-program index controller state root. The controller must be stopped.
    #[arg(long)]
