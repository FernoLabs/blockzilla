...
use blockzilla_format::{
    ...
    WincodeLeb128FramedReader, bounded_wincode_leb128_config,
};
...
pub fn consolidate_epoch_shards(archive_root: &Path, input: &Path, output: &Path) -> Result<()> {
    crate::consolidate_v3::consolidate_epoch_shards_v3(archive_root, input, output)
}
