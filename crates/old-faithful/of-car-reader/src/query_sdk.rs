...
/// Typed errors retained as the source of `blockzilla_model::Error::Source`.
...
struct ProjectionScratch {
    ...
    block_counts: Option<blockzilla_model::BlockCounts>,
...
fn scan_projected_blocks(
    ...
    mut next_block: impl FnMut(&mut OrderedLosslessCarBlock) -> blockzilla_model::Result<bool>,
...
fn project_block(
    ...
    scratch.block_counts = request
        .counts_only
        .then(blockzilla_model::BlockCounts::default);
...
fn count_protobuf_transaction(
    ...
    frame: &[u8],
    zstd: &mut ZstdReusableDecoder,
    counts: &mut blockzilla_model::BlockCounts,
    limits: CarQueryLimits,
) -> CarQueryResult<()> {
    use crate::metadata_decoder::{
...
mod tests {
    ...
    fn collect(
        ...
        request: &ScanRequest,
    ) -> blockzilla_model::Result<(ScanReceipt, Vec<CanonicalBlock>)> {
