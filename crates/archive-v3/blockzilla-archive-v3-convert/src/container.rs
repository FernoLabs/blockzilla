...
use blockzilla_archive_v3::{ArchiveId, FILE_HEADER_LEN, FileHeader, ObjectSpec, object_by_path};
...
// Compatibility exports; the reader owns all object decoding.
pub use blockzilla_archive_v3_reader::container::{
    decode_zstd_exact, payload_from_bytes, validate_open_file,
};
...
mod tests {
    ...
    use blockzilla_archive_v3::{FileHeader, ledger::transactions};
