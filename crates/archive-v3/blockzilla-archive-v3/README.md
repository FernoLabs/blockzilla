...
This crate defines the wire format for Blockzilla Archive V3 with few
external dependencies. Its public module tree mirrors the physical archive tree. A reader can
...
Current structured objects use Wincode 0.6.1 with canonical unsigned LEB128,
