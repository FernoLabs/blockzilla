...
`hivezilla/service/src/shred_status.rs`.
...
```bash
python3 hivezilla/service/scripts/test_ingest_status_server.py
bash hivezilla/service/scripts/test-linux-raw-grpc-cache-supervisor.sh
bash hivezilla/service/scripts/test-linux-raw-grpc-recorder-alerts.sh
bash hivezilla/service/scripts/test-run-grpc-raw-wrappers.sh
bash hivezilla/service/scripts/test-generate-grpc-replication-pki.sh
```
...
```bash
python3 hivezilla/service/scripts/ingest_status_server.py \
  --listen 127.0.0.1:8790 \
  --cache-root /path/to/read-only/grpc-cache \
  --ack-status-file /path/to/read-only/pull-ack-status.json \
  --known-gaps-file hivezilla/service/config/known-ingest-gaps.mainnet.json \
